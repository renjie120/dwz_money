...
(function($) {  
    $.addGt = function(t, p) {   
        ...
        p = $.extend({
            ...
            title: '', 
            exchangeColor: true,
            closeImg: '/gridTree/images/minus.gif',
            openImg: '/gridTree/images/plus.gif',
            lazyLoadImg: '/gridTree/images/plus2.gif',
            blankImg: '/gridTree/images/blank.gif',
            noparentImg: '/gridTree/images/tv-item.gif',
            lastLeafImg: '/gridTree/images/tv-item-last.gif',
            morePageImg: '/gridTree/images/morePage.gif',
