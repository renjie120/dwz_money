		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					...
					<td> 
						操作原因</td><td>
							<input name="logDetail" size="20"  class="textInput " type="text"  value="<s:property value="vo.logDetail"/>" />
					</td> 
				</tr>
			</table>
			<div class="subBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li>
				<a class="add" href="/money/userupdatelogger!beforeAdd.do" target="dialog" mask="true"
		...
		<tbody>
			<s:iterator value="list" status="stu">
				<tr target="sno" rel="<s:property value="sno" />">
					...
					<td style="text-align:center;">
						<div style='width:100px'><s:property value="userId" /></div>
					</td> 
					<td style="text-align:center;">
						<div style='width:100px'><s:property value="state" /></div>
					</td> 
					<td style="text-align:center;">
						<div style='width:100px'><s:property value="logDetail" /></div>
					</td> 
				</tr>
			</s:iterator>
		</tbody>
