		...
		<div class="pageFormContent" layoutH="57">
					 ...
					 <div class="unit">
						<label>
							...
							<my:newselect tagName="condition1_createTime" selectFlag="true" paraType="query_num" width="140" /><input type="text" name="query1_createTime" class="date " size="25" readOnly="true"   />
							<a class="inputDateButton" href="javascript:;">选择</a>
							<my:newselect tagName="condition2_createTime" selectFlag="true" paraType="query_num" width="140" /><input type="text" name="query2_createTime" class="date " size="25" readOnly="true"   />
							<a class="inputDateButton" href="javascript:;">选择</a> 
					</div>
					 <div class="unit">
						<label>
					 ...
					 <div class="unit">
						<label>
							...
							<my:newselect tagName="condition1_updateTime" selectFlag="true" paraType="query_num" width="140" /><input type="text" name="query1_updateTime" class="date " size="25" readOnly="true"   />
							<a class="inputDateButton" href="javascript:;">选择</a>
							<my:newselect tagName="condition2_updateTime" selectFlag="true" paraType="query_num" width="140" /><input type="text" name="query2_updateTime" class="date " size="25" readOnly="true"   />
							<a class="inputDateButton" href="javascript:;">选择</a> 
					</div>
		</div>
		<div class="formBar">
