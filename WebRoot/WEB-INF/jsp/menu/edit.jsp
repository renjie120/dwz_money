...
<div class="pageContent">
	<form method="post" action="/money/menu!doUpdate.do"
		...
		<div class="pageFormContent" layoutH="57">
			<div class="unit">
				<label> 菜单名: </label> <input name="menuName"
					class="textInput  required " size="30" type="text"
					value="<s:property value="menuVo.menuName"/>" />
			</div>
			<div class="unit">
				<label> 链接: </label> <input name="url" class="textInput  " size="30"
					type="text" value="<s:property value="menuVo.url"/>" />
			</div>
			<!--  
			<div class="unit">
				<label>
			...
			<div class="unit">
				<label> 父级菜单: </label> <input name="parentId" class="textInput  "
					size="30" type="text" 
			...
			<div class="unit">
				<label> 菜单页编码: </label> <input name="relId" class="textInput  "
					size="30" type="text" value="<s:property value="menuVo.relId"/>" />
			</div>
