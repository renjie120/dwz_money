		...
		<div class="searchBar">
			...
			<div class="subBar">
				<ul>
					...
					<li>
						<a class="button" href="/money/param!beforeQuery.do"
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li>
				<a class="add" href="/money/param!beforeAdd.do" target="dialog" mask="true"
			...
			<li>
				<a class="edit" href="/money/param!beforeUpdate.do?paramId={paramId}" mask="true"
					target="dialog" title="修改"><span>修改</span> </a>
			</li>
			<li>
				<a class="icon" href="/money/param!export.do" target="dwzExport"
	...
	<table class="table" layoutH="-138">
		<thead>
			<tr>
				...
				<th width="100"    orderField="PARAMID" >
						参数流水号 
				</th> 
				<th width="100"    orderField="PARAMTYPE" >
						参数类型 
				</th> 
				<th width="200"    orderField="PARAMNAME" >
						参数描述 
				</th> 
				<th width="100"    orderField="PARAMVALUE" >
						参数值 
				</th> 
				<th width="100"    orderField="USEVALUE" >
						用户自定义值 
				</th> 
		...
		<tbody>
			<s:iterator value="list" status="stu">
				<tr target="paramId" rel="<s:property value="paramId" />">
					<td>
						<input name="ids" value="<s:property value="paramId" />"
							type="checkbox">
					</td>
					<td>
						<s:property value="paramId" />
					</td> 
					<td>
						<s:property value="paramType" />
					</td> 
					<td>
