	...
	<table class="table" layoutH="-138">
		<thead>
			<tr>
				...
				<th width="130"    orderField="OPERTIME" >
						时间  
				</th> 
				<th width="150"    orderField="OPERTYPE" >
						操作类型 
				</th> 
		...
		<tbody>
			<s:iterator value="list" status="stu">
				<tr target="sno" rel="<s:property value="sno" />">
					...
					<td>
						<div style='width:130px'><s:property value="operTime" /></div>
					</td> 
					<td>
						<div style='width:150px' title='<s:property value="operType" />'><s:property value="operType" /></div>
					</td> 
					<td>
					...
					<td>
						<div style='width:300px'  title='<s:property value="operDesc" />'><s:property value="operDesc" /></div>
					</td> 
				</tr>
			</s:iterator>
		</tbody>
