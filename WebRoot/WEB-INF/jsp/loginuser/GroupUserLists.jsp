...
<script type="text/javascript"> 
 ...
 function refreshThisDialog(json){  
  ...
  function deleteUser(url,obj){   
   var checkedItem =  $('input[type=checkbox][name=groupUsers]:checked');
...
<div class="pageContent">
		...
		<ul class="toolBar">
			<li>
				<a class="add" href="javascript:;" 
					onclick="addUser('/money/loginuser!beforeAddGroupUser.do',this)"  mask="true"  
					 ><span>添加</span> </a>
			</li>
			<li>
				<a class="delete" href="javascript:;" 
					onclick="deleteUser('/money/loginuser!deleteGroupUser.do',this)"     
					 > <span>删除</span>
				</a>
			</li>  
		</ul>
	...
	<table class="table" >
		<thead>
			<tr>
				<th width="30">
					<input type="checkbox" group="groupUsers" class="checkboxCtrl">
				</th>
			...
			<s:iterator value="list" status="stu">
				<tr target="sno" rel="<s:property value="sno" />">
					<td style="text-align:center;">
						<input name="groupUsers" value="<s:property value="sno" />"
							type="checkbox">
					</td>
					<td style="text-align:center;">
