...
<form id="pagerForm" method="post" action="/money/addmoneydetail!query.do">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="/money/addmoneydetail!query.do" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li>
				<a class="add" href="/money/addmoneydetail!beforeAdd.do" target="dialog" mask="true"
					title="添加"><span>添加</span> </a>
			</li>
			<li>
				<a class="delete" href="/money/addmoneydetail!doDelete.do" postType="string"
		...
		<tbody>
			<s:iterator value="list" status="stu">
				<tr target="sno" rel="<s:property value="sno" />">
					...
					<td style="text-align:center;">
						<div style='width:100px'><s:property value="addMoney" /></div>
					</td> 
					<td style="text-align:center;">
						<div style='width:100px'><s:property value="insuredFileId" /></div>
					</td> 
					<td style="text-align:center;">
						<div style='width:100px'><s:property value="addTime" /></div>
					</td> 
					<td style="text-align:center;">
						<div style='width:100px'><s:property value="createUserName" /></div>
					</td> 
				</tr>
			</s:iterator>
		</tbody>
