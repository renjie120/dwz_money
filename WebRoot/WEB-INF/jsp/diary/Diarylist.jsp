		...
		<div class="searchBar">
			...
			<div class="subBar">
				<ul>
					...
					<li>
						<a class="button" href="/money/diary!beforeQuery.do"
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li>
				<a class="edit" href="/money/diary!beforeUpdate.do?diaryId={diaryId}" mask="true"
					target="dialog" title="修改"><span>修改</span> </a>
			</li>
			<li>
				<a class="icon" href="/money/diary!export.do" target="dwzExport"
	...
	<table class="table" layoutH="-138">
		<thead>
			<tr>
				...
				<th width="100"    orderField="DIARYTYPE" >
						日志类型 
				</th> 
			</tr>
		</thead>
		<tbody>
			<s:iterator value="list" status="stu">
				<tr target="diaryId" rel="<s:property value="diaryId" />">
					<td>
						<input name="ids" value="<s:property value="diaryId" />"
							type="checkbox">
					</td>
					<td>
						<s:property value="diaryId" />
					</td> 
					<td>
						<s:property value="diaryContent" />
					</td> 
					<td>
						<s:property value="diaryTime" />
					</td> 
					<td>
						<s:property value="diaryType" />
					</td> 
				</tr>
			</s:iterator>
		</tbody>
