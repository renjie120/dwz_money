	...
	<table class="table" layoutH="-138">
		<thead>
			<tr>
				...
				<th width="100"    orderField="URLDESC" >
						链接描述  
				</th> 
				<th width="100"    orderField="URL" >
						链接 
				</th> 
				<th width="100"    orderField="TYPEID" >
						类型 
				</th> 
			</tr>
		</thead>
		<tbody>
			<s:iterator value="list" status="stu">
				<tr target="urlId" rel="<s:property value="urlId" />">
					<td>
						<input name="ids" value="<s:property value="urlId" />"
							type="checkbox">
					</td>
					<td>
						<s:property value="urlDesc" />
					</td> 
					<td>
