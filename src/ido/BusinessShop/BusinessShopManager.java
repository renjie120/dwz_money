 ...
 * http://www.iteye.com
 */ 
public interface BusinessShopManager  extends BusinessObjectManager {
	/**
	 * 根据条件查询分页信息.
	 * @param criterias 条件
	 ...
	 */
	@Transactional
	public void removeBusinessShops(String sno);
	 ...
	 * @return
	 */
	public BusinessShop getBusinessShop(int sno);
