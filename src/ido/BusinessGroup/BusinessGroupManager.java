 ...
 * http://www.iteye.com
 */ 
public interface BusinessGroupManager  extends BusinessObjectManager {
	/**
	 * 根据条件查询分页信息.
	 * @param criterias 条件
	 ...
	 */
	@Transactional
	public void removeBusinessGroups(String sno);
	 ...
	 * @return
	 */
	public BusinessGroup getBusinessGroup(int sno);
