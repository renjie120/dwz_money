 ...
 * http://www.iteye.com
 */ 
public interface UserUpdateLoggerManager  extends BusinessObjectManager {
	/**
	 * 根据条件查询分页信息.
	 * @param criterias 条件
	 ...
	 */
	@Transactional
	public void removeUserUpdateLoggers(String sno);
	 ...
	 * @return
	 */
	public UserUpdateLogger getUserUpdateLogger(int sno);
