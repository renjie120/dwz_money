...
public class ParamAction extends BaseAction {
	...
	public enum ExportFiled {
		  PARAMID("参数流水号"),  PARAMTYPE("参数类型"),  PARAMNAME("参数描述"),  PARAMVALUE("参数值"),  USEVALUE("用户自定义值"),  ORDERID("排序号");
		private String str;
	...
	public String export() {
		...
		response.addHeader("Content-Disposition","attachment;filename=ParamList.xls");
		...
		Collection<Param> paramList = pMgr.searchParam(criterias, realOrderField(),
	...
	public String query() {
		...
		Collection<Param> moneyList = pMgr.searchParam(criterias, realOrderField(),
				startIndex, numPerPage);
