...
public class DiaryAction extends BaseAction {
	...
	public String doAdd() {
		try {
			DiaryImpl diaryImpl = new DiaryImpl(diaryContent ,diaryTime ,diaryType );
	...
	public String doUpdate() {
		try {
			DiaryImpl diaryImpl = new DiaryImpl( diaryId , diaryContent , diaryTime , diaryType );
	...
	public enum ExportFiled {
		  DIARYID("日志id"),  DIARYCONTENT("日志内容"),  DIARYTIME("开始时间"),  DIARYTYPE("日志类型");
		private String str;
	...
	public String export() {
		...
		response.addHeader("Content-Disposition","attachment;filename=DiaryList.xls");
		...
		Collection<Diary> diaryList = pMgr.searchDiary(criterias, realOrderField(),
	...
	public String query() {
		...
		Collection<Diary> moneyList = pMgr.searchDiary(criterias, realOrderField(),
				startIndex, numPerPage);
