...
public class PlanAction extends BaseAction {
	...
	public String doAdd() {
		try {
			PlanImpl planImpl = new PlanImpl(planDate,startDate,endDate,realStartDate,realEndDate,planDesc,planType,planStatus,userId);
	...
	public String doUpdate() {
		try {
			PlanImpl planImpl = new PlanImpl(planId,planDate,startDate,endDate,realStartDate,realEndDate,planDesc,planType,planStatus,userId);
  ...
  public void setRealStartDate(Date realStartDate) { this.realStartDate = realStartDate; } 
  public Date getRealStartDate() {  return realStartDate; }
  private Date realEndDate;
  public void setRealEndDate(Date realEndDate) { this.realEndDate = realEndDate; } 
  public Date getRealEndDate() {  return realEndDate; }
  ...
  public void setPlanStatus(int planStatus) { this.planStatus = planStatus; } 
  public int getPlanStatus() {  return planStatus; }
  private int userId;
